...
.emx-hero-layout{display:flex;gap:30px;align-items:center;width:100%;}
.emx-hero-info{flex:1 1 auto;min-width:0;}
...
.emx-product-image-box{flex:0 0 340px;background:rgba(255,255,255,.68);border:1px solid #c8ddf4;border-radius:26px;min-height:270px;padding:18px;display:flex;align-items:center;justify-content:center;box-shadow:0 18px 45px -32px rgba(6,23,58,.55);}
...
.emx-actions{max-width:1120px;margin:28px auto 18px;padding:0 24px;display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;}
.emx-btn{display:inline-flex;align-items:center;gap:9px;border-radius:14px;text-decoration:none;font-weight:900;padding:12px 16px;border:1px solid #d7e4f3;background:#fff;color:#0f1f3a;box-shadow:0 12px 35px -28px rgba(6,23,58,.45);}
.emx-btn-primary{background:#0875ef;border-color:#0875ef;color:#fff;}
@media(max-width:900px){.emx-ficha-page{padding:14px}.emx-ficha-hero,.emx-ficha-body{padding:24px 18px}.emx-hero-layout{display:block}.emx-product-image-box{width:100%;margin-top:20px;min-height:210px}.emx-meta-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.emx-ficha-title{font-size:28px}.emx-spec-head{display:block}.emx-spec-count{display:inline-block;margin-top:10px}.emx-spec-table th,.emx-spec-table td{padding:12px 10px;font-size:12px}.emx-col-num{width:54px}.emx-col-num span{width:30px;height:30px}.emx-product-image-box img{max-height:200px}}
@media(max-width:560px){.emx-actions{margin-top:18px}.emx-meta-grid{grid-template-columns:1fr}.emx-ficha-title{font-size:24px}.emx-ficha-logo{width:230px}.emx-product-image-box{min-height:180px}.emx-product-image-box img{max-height:170px}.emx-spec-table th:nth-child(1),.emx-spec-table td:nth-child(1){display:none}.emx-spec-table th,.emx-spec-table td{font-size:12px}.emx-section-title{font-size:22px}.emx-section-pad{padding:18px 14px}.emx-ficha-footer{padding:16px 18px}}
...
CSS;
        if ($pdf) {
            $base .= "\n@page{size:A4 portrait;margin:6mm;}html,body{background:#fff;font-size:11.5px}.emx-ficha-page{max-width:none;width:100%;padding:0}.emx-ficha-card{width:100%;border-radius:12px;box-shadow:none;border:1px solid #dce8f7;overflow:hidden}.emx-ficha-hero{padding:18px 20px;border-bottom:6px solid #0875ef}.emx-hero-layout{display:table;width:100%;table-layout:fixed;border-collapse:separate;border-spacing:0}.emx-hero-info{display:table-cell;width:64%;vertical-align:middle;padding-right:18px}.emx-product-image-box{display:table-cell;width:36%;vertical-align:middle;text-align:center;min-height:0;height:190px;padding:10px;border-radius:18px;box-shadow:none}.emx-product-image-box img{max-width:100%;max-height:170px;margin:0 auto}.emx-product-image-empty{height:170px;font-size:40px}.emx-ficha-logo{width:235px;margin-bottom:10px}.emx-kicker{font-size:9.5px;margin-bottom:7px;letter-spacing:.24em}.emx-ficha-title{font-size:22px;margin-bottom:10px;line-height:1.08}.emx-meta-grid{display:block;margin-top:8px}.emx-meta-card{display:inline-block;width:47%;vertical-align:top;margin:0 6px 8px 0;padding:8px 9px;border-radius:10px;min-height:44px}.emx-meta-card small{font-size:7.8px;margin-bottom:3px}.emx-meta-card strong{font-size:9.8px;line-height:1.25}.emx-ficha-body{padding:14px 20px 16px}.emx-section{margin-bottom:14px;border-radius:14px}.emx-section-pad{padding:14px 16px}.emx-section-label{font-size:8.5px;letter-spacing:.22em}.emx-section-title{font-size:17px;line-height:1.12}.emx-description{font-size:9.7px;line-height:1.5;margin-top:6px}.emx-spec-head{display:table;width:100%;margin-bottom:9px}.emx-spec-head>div{display:table-cell;vertical-align:bottom}.emx-spec-count{display:table-cell;width:112px;text-align:center;vertical-align:bottom;font-size:8px;padding:5px 7px}.emx-spec-table-wrap{border-radius:10px}.emx-spec-table th{font-size:7.8px;padding:7px 8px;letter-spacing:.08em}.emx-spec-table td{font-size:8.8px;padding:7px 8px;line-height:1.28}.emx-col-num{width:38px}.emx-col-num span{width:21px;height:21px;border-radius:6px;font-size:7.5px;display:inline-block;line-height:21px;text-align:center}.emx-ficha-footer{padding:9px 20px;font-size:7.8px;page-break-inside:avoid}.emx-section,.emx-product-image-box,.emx-meta-card{page-break-inside:avoid}.emx-spec-table tr{page-break-inside:avoid;page-break-after:auto}";
        }
        return $base;
    }
}
...
<body>
        ...
        <div class="emx-actions no-print">
            ...
            <a href="<?= emxFichaEscape($pdfUrl) ?>" class="emx-btn emx-btn-primary"><i class="fas fa-file-pdf"></i>Descargar PDF</a>
        </div>
        <?php endif; ?>
