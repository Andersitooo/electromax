...
/* Responsividad final portal proveedor */
html,body{max-width:100%;overflow-x:hidden}main{min-width:0}.proveedor-responsive-table,main .overflow-x-auto{max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}table{border-collapse:collapse}@media(max-width:1180px){body.flex{flex-direction:column;height:auto!important;min-height:100vh}.sidebar{width:100%!important;min-height:auto!important;height:auto!important;max-height:42vh;position:sticky!important;top:0!important;z-index:50}.sidebar nav{display:flex;gap:.55rem;overflow-x:auto;overflow-y:hidden;white-space:nowrap;padding:.75rem!important;scrollbar-width:thin}.sidebar nav a{min-width:max-content;flex-shrink:0}.sidebar .p-6{padding:1rem!important}main.flex-1{width:100%;overflow-x:hidden!important}main header{padding:1rem!important}main>div.p-8{padding:1rem!important}main table{min-width:780px}.modal-content{width:calc(100vw - 1rem)!important;max-height:92vh!important}.modal-content .grid{grid-template-columns:1fr!important}.oferta-card .grid{grid-template-columns:1fr!important}}@media(max-width:640px){main header h2{font-size:1.25rem!important}.btn-primary,button[type=submit],a.btn-primary{width:100%;justify-content:center}.rounded-2xl,.rounded-3xl{border-radius:1rem!important}input,select,textarea{font-size:16px!important}}
