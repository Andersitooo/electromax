...
<?php endif; ?></main><?php endif; ?><!-- Modal de Stock --><div id="stock-modal" class="hidden fixed inset-0 z-[100] modal-overlay flex items-center justify-center p-4"><div class="modal-content bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center border border-slate-100"><div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4"><i class="fas fa-exclamation-triangle text-3xl text-amber-600"></i></div><h3 class="text-xl font-bold text-slate-900 mb-2">Stock Insuficiente</h3><p class="text-slate-600 mb-6" id="stock-message">No hay suficientes unidades disponibles</p><button type="button" onclick="closeStockModal()" class="w-full py-3 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition active:scale-95">Entendido
